...
function ChoosePlan({ user }: ChoosePlanProps) {
  ...
  async function checkout() {
    ...
    if (plan === 'Yearly') {
      ...
      // You need to replace 'app' and 'getCheckoutUrl' with their actual values
          ...
          <div className="container">
            ...
            <div onClick={()=>{setplan("Yearly")}} className={`plan__card ${plan === "Yearly" && "plan__card--active"}`}>
              <div className="plan__card--circle"  >
                {plan ==="Yearly" &&<div className="plan__card--dot"  ></div>}
              </div>
            ...
            <div onClick={()=>{setplan("Monthly")}} className={`plan__card ${plan === "Monthly" && "plan__card--active"}`}>
              <div className="plan__card--circle"  >
              {plan ==="Monthly" &&<div className="plan__card--dot"  ></div>}
              </div>
              <div className="plan__card--content"  >
                <div className="plan__card--title"  >
                  Premium Monthly
